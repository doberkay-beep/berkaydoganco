...
export default async function YaziPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main style={{ maxWidth: "700px", margin: "0 auto", padding: "clamp(3rem, 8vh, 6rem) clamp(1.25rem, 5vw, 3.25rem) 6rem" }}>
      ...
      <OkumaCubugu />
      <p style={{ fontFamily: "var(--font-grotesk)", fontSize: "0.7rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--accent-2)", marginBottom: "1rem" }}>
        {y.dateText} · {okumaSuresi(y)} dk
      </p>
